...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased ">
        <div class="min-h-screen sm:justify-center items-center flex flex-col pt-6 sm:pt-0   bg-gray-100 dark:bg-gray-900"
         style="background: linear-gradient(to bottom, rgb(10, 119, 83), rgb(3, 3, 3) 120%);">
            <div>
                {{-- <a href="/"> --}}
                    <x-application-logo class="fill-current text-gray-500 w-10 h-10" />
                {{-- </a> --}}
            </div>
